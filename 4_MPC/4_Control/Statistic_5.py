...
x1 = np.load(path + '/PID_Statics1.npy')
x2 = np.load(path + '/PID_Statics2.npy')
x3 = np.load(path + '/PID_Statics3.npy')
x4 = np.load(path + '/PID_Statics4.npy')
...
np.save(path + '/PID_Statics1.npy', statistic)
#
