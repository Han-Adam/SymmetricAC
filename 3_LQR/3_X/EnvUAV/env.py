...
from .controller import HeightPID, AttitudePID
import numpy as np
...
class RollControlEnv:
    def __init__(self,
        ...
        self.height_controller = HeightPID(P=2.58, I=0, D=1.42)
    ...
    def step(self, a):
        ...
        z_a = self.height_controller.computControl(self.current_pos[2], self.target[2])
